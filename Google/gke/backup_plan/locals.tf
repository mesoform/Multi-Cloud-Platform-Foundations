locals {
  ...
  # This works as long as var.backup_plans_specs is null and is not {}, otherwise there would be an error with
  backup_plans_specs_unmerged = var.backup_plans_specs == null ? local.backup_plans_components_specs : var.backup_plans_specs

#  # Had attempted to get this to work regardless of whether var.backup_plans_specs is null or {}
...
#  # This only effects the specific use case seen in the deployment tests.
